  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center gap-3">
        ...
        <span className="text-lg font-medium tracking-wide font-serif text-italic  text-slate-100  group-hover:text-white group-hover:font-bold transition-colors">
          Start Full Youtube Analysis
        </span>
